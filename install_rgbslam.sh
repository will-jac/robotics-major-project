...
echo "Make sure that FindG2O.cmake is in the folder '$G2OCMAKEDIR'"
echo "Press enter to continue, Ctrl-C to cancel"
read

if [ ! -f FindG2O ]; then
  echo "You lied! FindG2O.cmake was not found."
  exit
fi
...
cp $G2OCMAKEDIR/FindG2O.cmake $WORKSPACE/src/rgbdslam/cmake-modules/.
