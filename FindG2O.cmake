...
IF(UNIX)
  ...
  IF(NOT "$ENV{G2O_DIR}" STREQUAL "")
    MESSAGE(STATUS "Searching for g2o in $ENV{G2O_DIR}... and ${G2O_INCLUDE_DIR} and ${G2O_LIBRARIES}")
    SET(G2O_INCLUDE_DIR $ENV{G2O_DIR}/include)
  ENDIF()
